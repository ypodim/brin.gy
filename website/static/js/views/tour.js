...
//   'text!templates/stats.html'
  ...
  var tourView = Backbone.View.extend({
    el: $("body"),
    events: {
        "click #tourBtn": "doTour",
        "keydown document": "exitTour",
        "click #covernextbtn": "nextTour",
        "click #coverbackbtn": "prevTour",
        "click #coverclosebtn": "close_tour",
    },
    ...
    nextTour: function(){
        ...
        if (index == Tour.tourSlides.length-1) {
            ...
            if (have_location == null)
                $("#get-location-modal").modal("show");
        } else {
            Tour.do_tour(index+1);
        }
        return false;
    },
    exitTour: function(event){
